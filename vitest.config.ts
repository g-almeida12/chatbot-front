...
export default defineConfig({
  ...
  test: {
    ...
    env: {
      VITE_API_URL: 'http://localhost:3333/chatbot/api',
      VITE_KEYCLOAK_JSON:
        '{"realm":"test","auth-server-url":"http://localhost/auth/","ssl-required":"external","resource":"chatbot-front-test","public-client":true,"confidential-port":0}',
    },
  },
})
